module.exports = (instance, _, next) => {
  ...
  var just_simplier = (request, reply, receipts, admin) => {
  ...
  instance.post('/reports/sales/by_category/:min/:max/:limit/:page', version, (request, reply) => {
  ...
  instance.get('/reports/sales/by_category/:token/:services/:employees/:custom/:limit/:page/:min/:max/:name', (request, reply) => {
    request.headers = {
