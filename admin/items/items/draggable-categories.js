module.exports = (instance, options, next) => {
  ...
  // get top categories
  instance.get(
    "/items/draggable/list_of_top_categories",
    version,
    (request, reply) => {
      instance.oauth_admin(request, reply, (admin) => {
        instance.goodsCategory.find(
          { organization: admin.organization, type: "top" },
          (_, categories) => {
            if (!categories) {
              categories = [];
            }
  ...
  instance.get(
    "/items/draggable/list_of_categories/:limit/:page",
    version,
    (request, reply) => {
      instance.oauth_admin(request, reply, (admin) => {
  ...
  instance.get(
    "/items/draggable/list_of_categories",
    version,
    (request, reply) => {
      instance.oauth_admin(request, reply, (admin) => {
        list_of_categories(request, reply, admin);
  ...
  instance.get(
    "/items/draggable/get/sub_categories/:id",
    options.version,
    (request, reply) => {
      instance.oauth_admin(request, reply, (admin) => {
  ...
  const create_category = (request, reply, admin) => {
    ...
    if (name) {
      instance.goodsCategory.findOne(
        ...
        (err, categ) => {
          if (err || categ == null) {
            var catModel = instance.goodsCategory(
              Object.assign(
                {
                  organization: admin.organization,
                },
  ...
  instance.post(
    "/items/draggable/list_of_categories/create",
    version,
    (request, reply) => {
      instance.oauth_admin(request, reply, (admin) => {
  ...
  const moderator_list_of_categories_update = async (request, reply, admin) => {
    ...
    for (const cat of body) {
      ...
      //   if (cat._id)
      //     await instance.goodsCategory
      //       .findByIdAndUpdate(cat._id, {
      //         $set: { draggable_position: cat.draggable_position },
      //       })
      //       .catch((err) => {});
    }

    await instance.goodsCategory.bulkWrite(bulkWrites).catch((err) => {});

    return moderator_list_of_categories(request, reply, admin);
  };

  instance.get(
    "/moderator/items/draggable/list_of_categories",
    { version: "2.0.0" },
    (request, reply) => {
      instance.oauth_admin(request, reply, (admin) => {
  ...
  instance.put(
    "/moderator/items/draggable/list_of_categories/update",
    { version: "2.0.0" },
    (request, reply) => {
      instance.oauth_admin(request, reply, (admin) => {
