...
module.exports = fp((instance, options, next) => {
  ...
  //     if (phone_number) {
  //       const user = await instance.User.findOne({ phone_number: phone_number }).lean()
  //       if (user) {
  //         return instance.aldy_exs(reply, 'phone_number')
  //       }
  //       const organization_name = request.body.organization
  //       const organization = await instance.organizations.findOne({ name: organization_name }).lean()
  ...
  //           })
  //           reply.ok()
  //           // instance.User.findOne({ organization: new_organization._id }, (error, _) => {
  //           //   if (error) {
